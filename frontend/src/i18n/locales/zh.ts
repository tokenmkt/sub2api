    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          groupCodex5hUsagePercent: 'Codex 5小时分组额度使用率 (%)',
          groupCodex5hRemainingPercent: 'Codex 5小时分组剩余额度 (%)',
        ...
        metricDescriptions: {
          ...
          groupCodex5hUsagePercent: '指定分组中可调度 OpenAI OAuth 账号的 Codex 5小时窗口加权平均使用率（0~100，需要 group_id 过滤）。',
          groupCodex5hRemainingPercent: '指定分组中可调度 OpenAI OAuth 账号的 Codex 5小时窗口加权平均剩余额度（0~100，需要 group_id 过滤）。',
