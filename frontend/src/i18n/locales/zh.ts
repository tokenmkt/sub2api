export default {
  ...
  home: {
    ...
    heroDescription:
      'tokenMKT 面向正式业务场景，提供统一鉴权、智能路由、实时计费与健康切换，让上游能力以更稳的方式进入你的系统。',
    ...
    quickstart: {
      ...
      response: '你好！我是 tokenMKT 官方 API 网关。'
    },
    metrics: {
      official: {
        label: '官方 API',
  ...
  installGuide: {
    badge: '安装与配置',
    title: '安装教程',
    subtitle: '按照你常用的 AI CLI 工具选择对应配置，几分钟内接入 tokenMKT 官方 API 网关。',
    backHome: '返回首页',
    overviewTitle: '安装流程',
    stepPrefix: '步骤',
    ...
    codex: {
      ...
      check2: '准备好 tokenMKT API Key，例如 sk-tokenmkt-...。',
      ...
      configBlockDesc: '将模型提供方切到 OpenAI，并把请求发到 tokenMKT 网关。',
      authBlockTitle: '写入 API Key',
      authBlockDesc: '把你的 tokenMKT Key 放进 auth.json，CLI 会自动读取。',
      verifyBlockTitle: '验证是否安装完成',
      verifyBlockDesc: '执行后如果 CLI 可以正常启动并继续会话，就说明接入成功。'
    },
    claude: {
      summaryTitle: 'Claude Code 接入',
      summary: '适合使用 Claude Code 或 VSCode Claude Code 插件的场景。核心是把 Anthropic 相关环境变量切到 tokenMKT 网关。',
      ...
      verifyBlockTitle: '验证是否安装完成',
      verifyBlockDesc: '执行后如果 Claude Code 能正常打开会话，即表示链路已经切到 tokenMKT。'
    },
    gemini: {
      ...
      check1: '确保本机已安装 Node.js 18+。',
      check2: '准备好 tokenMKT API Key，并确认你的网络可以访问 tokenMKT 网关。',
      check3: '如果你本机已有旧的 Gemini 环境变量，建议先清掉再重新设置。',
      installBlockTitle: '安装 Gemini CLI',
      installBlockDesc: '先安装 CLI 工具本体，再接入 tokenMKT 的 Gemini 网关地址。',
      envBlockTitle: '配置 Gemini 环境变量',
      envBlockDesc: '设置 Base URL、API Key 和默认模型后，CLI 就会走 tokenMKT 通道。',
      verifyBlockTitle: '验证是否安装完成',
  ...
  admin: {
    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          group5hQuotaUsagePercent: '5小时分组额度使用率 (%)',
          group5hQuotaRemainingPercent: '5小时分组剩余额度 (%)',
        ...
        metricDescriptions: {
          ...
          group5hQuotaUsagePercent: '指定分组中可调度 OAuth 账号的 5小时额度加权平均使用率；OpenAI 分组使用 Codex 额度快照，Anthropic 分组使用 Claude 会话窗口（0~100，需要 group_id 过滤）。',
          group5hQuotaRemainingPercent: '指定分组中可调度 OAuth 账号的 5小时额度加权平均剩余额度；OpenAI 分组使用 Codex 额度快照，Anthropic 分组使用 Claude 会话窗口（0~100，需要 group_id 过滤）。',
    ...
    settings: {
      ...
      notifications: {
        title: '通知渠道设置',
        description: '配置系统通知渠道，不影响现有邮件配置。',
        feishuTitle: '飞书告警',
        feishuDescription: '告警触发时通过飞书自定义机器人发送通知。',
        feishuEnabled: '启用飞书告警',
        webhooks: '飞书 Webhook',
        ...
        loadFailed: '加载通知设置失败',
        saveFailed: '保存通知设置失败',
        webhooksRequired: '启用飞书告警前请先添加 Webhook',
        invalidWebhook: '请输入有效的 http(s) Webhook URL',
      },
      features: {
        channelMonitor: {
          title: '渠道监控',
      ...
      linuxdo: {
        ...
        description: '配置 LinuxDo Connect OAuth，用于 tokenMKT 用户登录',
      ...
      smtp: {
        ...
        resendApiKeyPlaceholder: 're_xxxxxxxxx',
        resendApiKeyHint: '使用 Resend HTTPS API 发送邮件，适合 Railway 等禁用 SMTP 出站的平台。',
        resendApiKeyConfiguredPlaceholder: '已配置',
        resendApiKeyConfiguredHint: 'API Key 已配置，留空以保留当前值。',
        host: 'SMTP 主机',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 tokenMKT',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">tokenMKT 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p style="margin-bottom: 12px;"><b>🎯 核心功能：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p style="color: #10b981; font-weight: 600;">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>什么是分组？</b></p><p style="margin-bottom: 12px;">分组是 tokenMKT 的核心概念，它就像一个"服务套餐"：</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
    ...
    user: {
      welcome: {
        title: '👋 欢迎使用 tokenMKT',
        description:
          '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">您好！欢迎来到 tokenMKT AI 服务平台。</p><p style="margin-bottom: 12px;"><b>🎯 快速开始：</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p style="color: #10b981; font-weight: 600;">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
