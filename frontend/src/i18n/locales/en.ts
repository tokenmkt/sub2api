export default {
  ...
  admin: {
    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          group5hQuotaUsagePercent: '5h Group Quota Usage (%)',
          group5hQuotaRemainingPercent: '5h Group Quota Remaining (%)',
        ...
        metricDescriptions: {
          ...
          group5hQuotaUsagePercent: 'Weighted average 5-hour quota usage for schedulable OAuth accounts in the selected group. OpenAI groups use Codex quota snapshots; Anthropic groups use Claude session windows (0-100, requires group_id).',
          group5hQuotaRemainingPercent: 'Weighted average 5-hour quota remaining for schedulable OAuth accounts in the selected group. OpenAI groups use Codex quota snapshots; Anthropic groups use Claude session windows (0-100, requires group_id).',
    ...
    settings: {
      ...
      notifications: {
        ...
        description: 'Configure system notification channels without changing existing email settings.',
        feishuTitle: 'Feishu Alerts',
        feishuDescription: 'Send alert notifications through Feishu custom bots when alerts fire.',
        feishuEnabled: 'Enable Feishu alerts',
        ...
        webhooksRequired: 'Add a webhook before enabling Feishu alerts',
        invalidWebhook: 'Enter a valid http(s) webhook URL',
      },
      features: {
        channelMonitor: {
          title: 'Channel Monitor',
      ...
      linuxdo: {
        ...
        description: 'Configure LinuxDo Connect OAuth for tokenMKT end-user login',
      ...
      smtp: {
        ...
        resendApiKeyHint: 'Use the Resend HTTPS API for platforms such as Railway that block outbound SMTP.',
        resendApiKeyConfiguredPlaceholder: 'Configured',
        resendApiKeyConfiguredHint: 'API key configured. Leave empty to keep the current value.',
        host: 'SMTP Host',
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 Welcome to tokenMKT',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">tokenMKT is a powerful AI service gateway platform that helps you easily manage and distribute AI services.</p><p style="margin-bottom: 12px;"><b>🎯 Core Features:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>📦 <b>Group Management</b> - Create service tiers (VIP, Free Trial, etc.)</li><li>🔗 <b>Account Pool</b> - Connect multiple upstream AI service accounts</li><li>🔑 <b>Key Distribution</b> - Generate independent API Keys for users</li><li>💰 <b>Billing Control</b> - Flexible rate and quota management</li></ul><p style="color: #10b981; font-weight: 600;">Let\'s complete the initial setup in 3 minutes →</p></div>',
        nextBtn: 'Start Setup 🚀',
        prevBtn: 'Skip'
      },
      groupManage: {
        title: '📦 Step 1: Group Management',
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;"><b>What is a Group?</b></p><p style="margin-bottom: 12px;">Groups are the core concept of tokenMKT, like a "service package":</p><ul style="margin-left: 20px; margin-bottom: 12px; font-size: 13px;"><li>🎯 Each group can contain multiple upstream accounts</li><li>💰 Each group has independent billing multiplier</li><li>👥 Can be set as public or exclusive</li></ul><p style="margin-top: 12px; padding: 8px 12px; background: #f0fdf4; border-left: 3px solid #10b981; border-radius: 4px; font-size: 13px;"><b>💡 Example:</b> You can create "VIP Premium" (high rate) and "Free Trial" (low rate) groups</p><p style="margin-top: 16px; color: #10b981; font-weight: 600;">👉 Click "Group Management" on the left sidebar</p></div>'
      },
      createGroup: {
    ...
    user: {
      welcome: {
        title: '👋 Welcome to tokenMKT',
        description: '<div style="line-height: 1.8;"><p style="margin-bottom: 16px;">Hello! Welcome to the tokenMKT AI service platform.</p><p style="margin-bottom: 12px;"><b>🎯 Quick Start:</b></p><ul style="margin-left: 20px; margin-bottom: 16px;"><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p style="color: #10b981; font-weight: 600;">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
  ...
  payment: {
    ...
    admin: {
      ...
      createRechargePlan: 'Create Recharge Plan',
      editRechargePlan: 'Edit Recharge Plan',
      deleteRechargePlan: 'Delete Recharge Plan',
      deleteRechargePlanConfirm: 'Are you sure you want to delete this recharge plan?',
      creditAmount: 'Credited Balance',
      purchaseUrl: 'Purchase URL',
      badge: 'Badge',
      rechargePlanNameRequired: 'Please enter a recharge plan name',
      rechargePlanAmountRequired: 'Price and credited balance must be greater than 0',
      purchaseUrlInvalid: 'Purchase URL must start with http:// or https://',
