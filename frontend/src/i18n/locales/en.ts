    ...
    ops: {
      ...
      alertRules: {
        ...
        metrics: {
          ...
          groupCodex5hUsagePercent: 'Codex 5h Group Quota Usage (%)',
          groupCodex5hRemainingPercent: 'Codex 5h Group Quota Remaining (%)',
        ...
        metricDescriptions: {
          ...
          groupCodex5hUsagePercent: 'Weighted average Codex 5-hour window usage for schedulable OpenAI OAuth accounts in the selected group (0-100, requires group_id).',
          groupCodex5hRemainingPercent: 'Weighted average Codex 5-hour window remaining quota for schedulable OpenAI OAuth accounts in the selected group (0-100, requires group_id).',
