export default {
  ...
  payment: {
    ...
    admin: {
      ...
      editRechargePlan: '编辑充值套餐',
      deleteRechargePlan: '删除充值套餐',
      deleteRechargePlanConfirm: '确定要删除此充值套餐吗？',
      creditAmount: '到账余额',
      purchaseUrl: '购买链接',
      badge: '标签',
      rechargePlanNameRequired: '请输入充值套餐名称',
      rechargePlanAmountRequired: '价格和到账余额必须大于 0',
      purchaseUrlInvalid: '购买链接必须以 http:// 或 https:// 开头',
      tabs: {
        overview: '概览',
        orders: '订单管理',
        channels: '支付渠道',
