      ...
      <template v-else>
        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div v-if="checkout.recharge_plans.length === 0 && enabledMethods.length === 0" class="card py-16 text-center">
...
const checkout = ref<CheckoutInfoResponse>({
  ...
  plans: [], recharge_plans: [], balance_disabled: false, balance_recharge_multiplier: 1, subscription_usd_to_cny_rate: 0, recharge_fee_rate: 0, help_text: '', help_image_url: '', stripe_publishable_key: '',
})
